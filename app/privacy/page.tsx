      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="prose max-w-none space-y-6">
          ...
          <section className="rounded-lg border bg-white p-6">
            ...
            <h3 className="mb-2 font-medium">Automatically Collected Information</h3>
          ...
          <section className="rounded-lg border bg-white p-6">
            <h2 className="mb-4 text-xl font-semibold">4. Information Sharing</h2>
            <p className="mb-3 text-muted-foreground">
              We may share your information with:
            </p>
            <ul className="list-inside list-disc space-y-1 text-muted-foreground">
              <li><strong>Service Providers:</strong> Companies that help us operate our business (payment processors, shipping companies)</li>
          ...
          <section className="rounded-lg border bg-white p-6">
            <h2 className="mb-4 text-xl font-semibold">6. Your Rights (UK GDPR)</h2>
            ...
            <ul className="list-inside list-disc space-y-1 text-muted-foreground">
              ...
              <li>Lodge a complaint with the German Data Protection Authority (Information Commissioner's Office)</li>
            </ul>
          </section>
          ...
          <section className="rounded-lg border bg-white p-6">
            ...
            <p className="text-muted-foreground">
              ...
              and personalize content. You can control cookies through your browser settings. See our Cookie Policy 
              for more details.
            </p>
          </section>

          <section className="rounded-lg border bg-white p-6">
            <h2 className="mb-4 text-xl font-semibold">8. Data Retention</h2>
            <p className="text-muted-foreground">
